...
const triggerWords = /\b(bot|simi|alexa|Хулиган)\b/i;
...
if (!systemPrompt) {
systemPrompt = await fetch('https://raw.githubusercontent.com/elrebelde21/Хулиган-MD/main/src/text-chatgpt.txt').then(v => v.text());
